...
public class ChamadoResource {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<ChamadoDTO> updateChamadoResource(@PathVariable Integer id, @Valid @RequestBody ChamadoDTO objDTO){
		Chamado newObj = chamadoService.updateChamadoService(id, objDTO);
